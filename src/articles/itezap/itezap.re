...
今回回帰モデルを作った目的の1つとして、新キャラの身体的特徴の予測があります。
なので、実際に構築した回帰モデルに当てはめてみましょう。
...
ここでの予測誤差は小数点第2位で四捨五入した絶対値としました。
...
この結果から最も予測に近い子はあきらちゃんになりました。
身長・バストともに1cmの誤差なのでかなり良い精度だと思います。
あかりちゃんはバストの予測結果は良いですが、身長の誤差は多少大きくなってしまいました。
一方でりあむはどちらも10cm以上の誤差があります。
たしかにイラストを見るだけでも、他の子と大きく異なることがわかります。

以上のことから、あかりちゃんとあきらちゃんは今回の回帰モデルから予測可能なキャラといえると思います。
なので、今回追加されたキャラたちの範囲では、そこそこ良い回帰モデルができたかと思います。
一方、りあむはプロフィールからもかなり異質であることがわかり、予測は困難であることがわかります。
このような予想外のデータに関してはどうしようもないですね。
...
この手法は各データの正解ラベルがなくても任意のグループに分類できるのがいいところですね。
