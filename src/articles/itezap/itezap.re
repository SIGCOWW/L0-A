...
1つはシンデレラガールズ（新キャラの3人を除く）の183人のデータを訓練データとし、それ以外のデータをテストデータとするデータセットです。
テストデータは、ミリオンライブとシャイニーカラーズのキャラ達を合わせたデータセットをテストデータ1とし、シンデレラガールズの新キャラ3人のデータをテストデータ2とします。
ここでのシンデレラガールズの新キャラ3人とは、辻野あかり、砂塚あきら、夢見りあむ、黒埼ちとせ、白雪千夜を指します。
