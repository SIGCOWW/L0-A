...
//tabooular[lori_cluster5][年齢を除いた幼少組クラスタリングの結果]{
名前	|	年齢（クラスタ）	&	本来の年齢
==========>|====&====
赤城みりあ	|	12	|	11	
市原仁奈	|	9	|	9	
...
//tabooular[lori_cluster6][3サイズのみを用いた幼少組クラスタリングの結果]{
名前	|	年齢（クラスタ）	&	本来の年齢
==========>|====&====
赤城みりあ	|	12	|	11	
市原仁奈	|	9	|	9	
...
//image[lori_millidere_nkmeans4_bwh][3サイズのみを用いた幼少組クラスタリングの可視化結果]
...
またクラスタリングの性質上、各クラスタの代表点に近いものを選んで1つのグループとします。
各クラスタの代表点を調べたところ、11才クラスタは梨沙、12才クラスタは桃華でした。
梨沙と桃華では、明らかに梨沙の方が育ちゃんに近いです（@<img>{lori_millidere_nkmeans4_bwh}参照）。
