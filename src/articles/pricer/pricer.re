...
//footnote[avr][AVRに詳しくなく、ヒューズビットをおかしな値に設定してしまいましたが…。10MHzを8分周して1.245MHzを生成しているので、外部クロック入力かつ分周比1/1の「10101000」を設定する必要があります。]
...
$ python rawcmd.py /dev/ttyS3 D4586030516411091 \
    37000000F0FFFFFFFFFFFFF88FFFFFDFFFFFE3FFFFFFFFFFF9FFFF 100
//}
